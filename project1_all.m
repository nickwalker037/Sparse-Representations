...
for s = 1:s_max
    ...
    for experiment = 1:num_realizations
        ...
        true_supp = sparse(randperm(m,s)); % m represents the column chosen, s represents how many columns to choose
        ...
        %L2_error(s,experiment,1) = 
        L2_error(s, experiment, 1) = (norm(x_omp - x,2)^2)/(norm(x,2)^2);
